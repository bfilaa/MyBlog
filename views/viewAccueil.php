...
<div class="slider">
	<div class="display-table  center-text">
		<h1 class="title display-table-cell"><b>BIENVENUE SUR My BLOG!</b></h1>
	</div>
</div><!-- slider -->
				...
				<div class="card h-100">
					<div class="single-post post-style-1">
						...
						<div class="blog-info">
							...
							<h4 class="title"><a href="#"><b>Pour pouvoir consulter nos rubriques et conseille veuillez vous s'inscrire.</b></a></h4>
