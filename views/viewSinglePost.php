						...
						<div class="row">
							...
							<div class="col-sm-6">
								<input type="text" aria-required="true" name="contact-form-name" class="form-control"
									placeholder="Entrer votre nom" aria-invalid="true" required >
							</div><!-- col-sm-6 -->
							<div class="col-sm-6">
								<input type="email" aria-required="true" name="contact-form-email" class="form-control"
									placeholder="Enter votre email" aria-invalid="true" required>
							</div><!-- col-sm-6 -->

							<div class="col-sm-12">
								<textarea name="contact-form-message" rows="2" class="text-area-messge form-control"
									placeholder="votre commentaire" aria-required="true" aria-invalid="false"></textarea ><br />
							</div><!-- col-sm-12 -->
							<div class="col-sm-12">
					...
					<div class="comment">
						...
						<div class="post-info">
							...
							<div class="right-area">
								<h5 class="reply-btn" ><a href="#"><b>REPONSE</b></a></h5>
							</div>
